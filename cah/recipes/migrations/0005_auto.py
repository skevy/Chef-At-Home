...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field menu on 'Recipe'
        db.delete_table('recipes_recipe_menu')


    def backwards(self, orm):
        
        # Adding M2M table for field menu on 'Recipe'
        db.create_table('recipes_recipe_menu', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('recipe', models.ForeignKey(orm['recipes.recipe'], null=False)),
            ('menu', models.ForeignKey(orm['menus.menu'], null=False))
        ))
        db.create_unique('recipes_recipe_menu', ['recipe_id', 'menu_id'])
    ...
    models = {
        ...
        'recipes.recipephoto': {
            ...
            'recipe': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photos'", 'to': "orm['recipes.Recipe']"}),
        ...
        'recipes.recipevideo': {
            ...
            'caption': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipe': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'videos'", 'to': "orm['recipes.Recipe']"})
        },
        'taggit.tag': {
