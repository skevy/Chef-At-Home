...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('recipes_recipe', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('menu', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.Menu'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ...
        db.create_table('recipes_recipephoto', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('recipes', ['RecipePhoto'])

        # Adding model 'RecipeVideo'
        db.create_table('recipes_recipevideo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.Recipe'])),
            ('caption', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('recipes', ['RecipeVideo'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('recipes_recipephoto')

        # Deleting model 'RecipeVideo'
        db.delete_table('recipes_recipevideo')
    ...
    models = {
        ...
        'recipes.recipe': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'menu': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['recipes.Menu']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
